...
public class Earthshock extends AbstractThrallCard
{
	public static final String ID = "Earthshock";
	public static final	String IMG = "cards/earthshock.png";
	...
	private static final int UPGRADE_V = 1;
