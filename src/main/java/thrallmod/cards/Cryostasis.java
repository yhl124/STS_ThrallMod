...
public class Cryostasis extends AbstractThrallCard {
    public static final String ID = "Cryostasis";
    public static final	String IMG = "cards/cryostasis.png";
