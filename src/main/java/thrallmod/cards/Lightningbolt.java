...
public class Lightningbolt extends AbstractThrallCard
{
	public static final String ID = "Lightningbolt";
	public static final	String IMG = "cards/lightningbolt.png";
	...
	public void use(AbstractPlayer p, AbstractMonster m)
	{
		...
		AbstractDungeon.actionManager.addToBottom(new VFXAction(new com.megacrit.cardcrawl.vfx.combat.ImpactSparkEffect(m.hb.cX, m.hb.cY)));
